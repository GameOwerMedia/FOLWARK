...
export type AnimalTask = 'idle' | 'moving' | 'harvest' | 'hauling' | 'eating' | 'resting' | 'refusing' | 'protesting' | 'wood' | 'stone' | 'patrol' | 'deposit' | 'build' | 'produce' | 'guard' | 'care' | 'study' | 'govern' | 'diplomacy';
